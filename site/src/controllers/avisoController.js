...
function listarPorFk(req, res) {
    var idEmpresa = req.params.idEmpresa;
    var emailFunc = req.params.emailFunc;
    avisoModel.listarPorFk(idEmpresa, emailFunc).then(function (resultado) {
...
function deletar(req, res) {
    ...
    avisoModel.deletar(idFuncionario)
        .then(
            function (resultado) {
                res.json(resultado);
            }
